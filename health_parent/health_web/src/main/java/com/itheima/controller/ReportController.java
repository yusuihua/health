...
public class ReportController {
    ...
    @GetMapping("/findMemberCountBetweenDate")
    public Result findMemberCountBetweenDate(@RequestParam  String startDate, String endDate){
        // 调用业务服务查询上过去一年的会员数量
        Map<String,List<Object>> data = memberService.findMemberCountBetweenDate(startDate,endDate);
        return new Result(true, MessageConstant.GET_MEMBER_NUMBER_REPORT_SUCCESS,data);
    }
}
